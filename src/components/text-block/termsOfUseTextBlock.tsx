    ...
    <div className="root">
      <section className="root-inner">
        <div className="frame-parent">
          ...
          <p className="p">&nbsp;</p>
          <p className="p">
            This website is operated by ONIEXP OÜ. Throughout the site, the terms "we", "us" and "our" refer to ONIEXP OÜ. ONIEXP OÜ offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
          </p>
          <p className="p">&nbsp;</p>
          <p className="p">
          ...
          <p className="p">&nbsp;</p>
          <p className="p">
            If, at our request, you send certain specific submissions (for example contest entries) or without a request from us you send creative ideas, suggestions, proposals, plans, or other materials, whether online, by email, by postal mail, or otherwise (collectively, 'comments'), you agree that we may, at any time, without restriction publish, distribute, translate and otherwise use in any medium any comments that you forward to us. We are and shall be under no obligation (1) to maintain any comments in confidence; (2) to pay compensation for any comments; or (3) to respond to any comments.
          </p>
          <p className="p">&nbsp;</p>
          <p className="p">
          ...
          <p className="p">&nbsp;</p>
          <p className="p">
            You agree to indemnify, defend and hold harmless ONIEXP OÜ and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys' fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
          </p>
          <p className="p">&nbsp;</p>
          <p className="p">
          ...
          <p className="p">&nbsp;</p>
          <p className="p">
            Questions about the Terms of Service should be sent to us at info@astro-irena.com.
          </p>
                </div>
              </div>
            </div>
...
export default TermsOfUseTextBlock; 