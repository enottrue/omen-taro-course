  ...
  return (
    <section className="to-learn">
      <div className="to-learn__grid">
        ...
        <div className="to-learn__card">
          <p>
            Курс разработан по&nbsp;книге &laquo;Настоящее таро Уэйта. История
            создания и&nbsp;тайны вокруг колоды.&nbsp;1910&nbsp;г.&raquo;
            совместно с методологами и&nbsp;обучит вас работе с&nbsp;самой
            известной колодой в&nbsp;мире.
          </p>
        </div>
      </div>
    </section>
