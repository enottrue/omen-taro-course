  ...
  <section className="way">
    <div className="way__wrapper">
      ...
      <div className="way__step way__step_2">
        ...
        <p>и историей возникновения колоды таро А. Уэйта и раскладами</p>
        <p>
          Если вам нужна определенная информация, но нет времени пересматривать
          курс, вы можете воспользоваться электронным пособием, максимально
          приближенным к курсу.
        </p>
      </div>
      ...
      <div className="way__step way__step_3">
        ...
        <p>
          Если нужно быстро посмотреть значение <br /> карты, можно пользоваться
          бумажной методичкой со шпаргалками. Рекомендуем использовать ее для
          помощи в толковании раскладов после того, <br /> как изучите материалы{' '}
      ...
      <div className="way__cards">
        ...
        <div className="way__cards-item bg-white">
          ...
          <div className="way__cards-item-desc">
            И после этого получайте подсказки прямо в процессе работы, используя
            печатное пособие и описания значений на картах.
          </div>
        </div>
      </div>
