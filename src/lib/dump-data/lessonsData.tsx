...
Приятного просмотра!`,
  ...
  },
  {
    ...
    stageDescription: `В колоду Таро Уэйт заложил основы ритуальной магии. Совершая ритуал, маги настраивают Вселенную на нужный лад. При помощи ритуалов можно настроить все, что угодно.
